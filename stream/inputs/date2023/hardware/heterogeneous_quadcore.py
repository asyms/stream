...
from stream.inputs.date2023.hardware.cores.ox_fx_fy import get_core as get_ox_fx_fy_core
from stream.inputs.date2023.hardware.cores.ox_k import get_core as get_ox_k_core
from stream.inputs.date2023.hardware.cores.c_k import get_core as get_c_k_core
from stream.inputs.date2023.hardware.cores.offchip import get_core as get_offchip_core
